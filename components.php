...
function render_header($site_title, $navigation_items) {
            ...
            <nav class="main-nav">
                <?php foreach ($navigation_items as $text => $url): ?>
                    <?php
                        ...
                        $is_active = (basename($url) === $current_page) ? 'active' : '';
                    ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const mainNav = document.querySelector('.main-nav'); // Menggunakan kelas karena ID main-nav sudah dihapus

            if (menuToggle && mainNav) {
                menuToggle.addEventListener('click', function() {
                    mainNav.classList.toggle('active'); // ini akan menambahkan/menghapus class 'active' pada <nav class="main-nav">
                    menuToggle.classList.toggle('active'); // Untuk animasi hamburger icon
                });
            }
            // Optional: Close mobile menu when a nav link is clicked
            const navLinks = document.querySelectorAll('.main-nav .nav-link'); // Ubah selektor
        ...
        <div class="container footer-content">
            ...
            <div class="footer-links">
                <ul>
                    ...
                    <li><a href="3booking.php">Booking</a></li>
                    <li><a href="4panduan.php">Panduan</a></li>
                    <li><a href="5.blog.php">Blog</a></li>
                    <li><a href="6komunitas.php">Komunitas</a></li>
                    <li><a href="7kontak.php">Kontak</a></li>
                </ul>
            </div>
